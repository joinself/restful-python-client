...
class FactCreateFactRequestDocFactsInner(BaseModel):
    """
    FactCreateFactRequestDocFactsInner
    """ # noqa: E501
    group: Optional[FactCreateFactRequestDocFactsInnerGroup] = None
    key: Optional[StrictStr] = None
    source: Optional[StrictStr] = None
    type: Optional[StrictStr] = None
    value: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["group", "key", "source", "type", "value"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "group": FactCreateFactRequestDocFactsInnerGroup.from_dict(obj.get("group")) if obj.get("group") is not None else None,
            "key": obj.get("key"),
