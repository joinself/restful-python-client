...
class FactCreateFactRequestDoc(BaseModel):
    """
    FactCreateFactRequestDoc
    """ # noqa: E501
    facts: Optional[List[FactCreateFactRequestDocFactsInner]] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "facts": [FactCreateFactRequestDocFactsInner.from_dict(_item) for _item in obj.get("facts")] if obj.get("facts") is not None else None
        })
        return _obj
