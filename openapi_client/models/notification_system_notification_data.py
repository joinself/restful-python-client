...
class NotificationSystemNotificationData(BaseModel):
    """
    NotificationSystemNotificationData
    """ # noqa: E501
    metadata: Optional[NotificationSystemNotificationDataMetadata] = None
    notification: Optional[NotificationSystemNotificationDataNotification] = None
    __properties: ClassVar[List[str]] = ["metadata", "notification"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "metadata": NotificationSystemNotificationDataMetadata.from_dict(obj.get("metadata")) if obj.get("metadata") is not None else None,
            "notification": NotificationSystemNotificationDataNotification.from_dict(obj.get("notification")) if obj.get("notification") is not None else None
        })
        return _obj
