...
class ConnectionResponse(BaseModel):
    ...
    ConnectionResponse
    """ # noqa: E501
    items: Optional[List[ConnectionConnection]] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "items": [ConnectionConnection.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None,
            "page": obj.get("page"),
